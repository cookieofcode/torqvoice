...
agents/
  ...
  COS_INTAKE.md             # public GitHub Issues → CoS wake (label + assign)
...
- CoS issue triage routine: [routines/torqvoice-cos-issue-triage.md](routines/torqvoice-cos-issue-triage.md)
