...
| **Build & Run** | [channels/build-and-run.md](channels/build-and-run.md) | Quality, Security, DevOps, FinOps | **Architect** on infra / topology (not a member; must review) |
...
Architect stays an Engineering member. On infra/topology, CoS **must** bring Architect into Build & Run as guest/reviewer before the product owner sees the PR.
